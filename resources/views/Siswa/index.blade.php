    ...
    <div class="p-4">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg border border-gray-300">
            <div class="w-full overflow-x-auto">
                <div>
                    <div
                        ...
                        <div
                            ...
                            <a href="{{ route('input') }}"
                                class="inline-block text-white box-border border bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none">
                                Tambah Data
                            </a>
                ...
                <div id="results">
                    @include('Siswa.search-results', ['siswas' => $siswas])
                </div>
            </div>
        </div>
    </div>
